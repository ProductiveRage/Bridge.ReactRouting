...
namespace ProductiveRage.ReactRouting
{
	public abstract class Navigator
	{
		...
		/// by the first argument and the Dispatcher action to raise if the route is matched is defined using the second argument.
		/// </summary>
		...
		/// </summary>
		protected void NavigateTo(params string[] segments)
		{
			if (segments == null)
			...
			_historyHandler.NavigateTo(new UrlDetails(nonBlankSegments));
		}
	}
}